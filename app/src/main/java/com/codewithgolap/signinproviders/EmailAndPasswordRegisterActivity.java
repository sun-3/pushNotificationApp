    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        regBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                final String password2 = Objects.requireNonNull(userPAssword2.getText()).toString();
                final String name = Objects.requireNonNull(userName.getText()).toString();
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            DocumentReference documentReference = fStore.collection("push-530ea/kkk/u9Hh5cxBX3tljFaGxnKJ").document(userID);
